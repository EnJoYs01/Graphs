...
void Task2::FindConnectionComponents(Graph& MyGraph, int startV) { 
	//Ищем компоненты связности в неориентированном графе через поиск в ширину
	...
	this->visited[startV] = true; //Устанавливаем текущую вершину как посещённую от текущей
